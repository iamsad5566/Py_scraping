...
// Check if the SearchByKeyword object implements Twipage
var _ TwiPage = (*SearchByKeyword)(nil)

// SetChoice sets the Choice variale for the SearchByKeyword object
func (s *SearchByKeyword) SetChoice(str string) {
	s.Choice = str
}

// SetLabel sets the LabelText Choice variable for the SearchByKeyword object
func (s *SearchByKeyword) SetLabel(str string) {
	label := ""
...
func (s *SearchByKeyword) GetOptionContainer() fyne.CanvasObject {
...
func (s *SearchByKeyword) getEntriesAndBtnContainer(str string) fyne.CanvasObject {
	s.SetLabel(str)
